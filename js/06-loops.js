...
Específicos: for/of, for/in (objetos) */
...
console.log("--------------------------------");
console.log("-- Resultado usando for (para) /of (de/do) --");

/*for/of é uma sintaxe exclusiva (e mais simples) para manipulação de dados de um array */
